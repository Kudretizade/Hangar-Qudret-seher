...
public class Grappling : MonoBehaviour
{
   ...
   [SerializeField] private Sprite openEye, closeEye;
   ...
   public void GrapplingOn()
   {
      ...
      gameObject.GetComponentInChildren<SpriteRenderer>().sprite = closeEye;
   ...
   {
      gameObject.GetComponentInChildren<SpriteRenderer>().sprite = openEye;
      tj2D.enabled = false;
      line.enabled = false;
   }
